  ...
  for ( var i = 0; i < texSize; i++ ) {
    for ( var j = 0; j < texSize; j++ ) {
        for (var k = 0; k < texSize; k++){
           img[4 * i * texSize + 4 * j + k] = 127 + 127 * Math.sin(0.1 * i * j * k);
           img[4 * i * texSize + 4 * j + k + 1 ] = 127 + 127 * Math.sin(0.1 * i * j * k);
           img[4 * i * texSize + 4 * j + k + 2] = 127 + 127 * Math.sin(0.1 * i * j * k);
           img[4 * i * texSize + 4 * j + k + 3] = 255;
        }
     }
  }
